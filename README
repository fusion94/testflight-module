...
<modules>
	<module version="0.1">com.testflight</module>
</modules>
...
For example,
	...
	var my_module = require('com.testflight');
	my_module.foo();
...
To create a module, create a file named com.testflight.js under the assets folder.
